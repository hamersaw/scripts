...
initializeANSI() {
    #esc="\033"
    esc=""
    # If this doesn't work, enter an ESC directly.
...
# inPath checks if the provided command is available 
